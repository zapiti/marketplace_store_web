...
class _HomePageOptionsState extends State<HomePageOptions> {
  ...
  Widget build(BuildContext context) {
    return Observer(
        builder: (_) => widget.controller.orders == null
            ? loadElements()
            : widget.controller.orders.isEmpty
                ...
                : GroupedListView(
                    ...
                    groupSeparatorBuilder: widget.controller.actualPage ==
                            widget.controller.ANDAMENTO
                        ? _buildGroupSeparator
                        : (x)=>SizedBox(),
                    itemBuilder: (context, element) =>
                        widget.controller.actualPage ==
                                widget.controller.ANDAMENTO
  ...
  Widget _buildGroupSeparator(dynamic groupByValue) {
    return Container(
        ...
        child: Text(
          groupByValue == widget.controller.ANDAMENTO ? "Em adamento" : "Novo pedido!",
          maxLines: 1,
